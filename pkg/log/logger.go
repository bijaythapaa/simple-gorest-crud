...
type Logger interface {
	...
	// With returns a loger based off the root logger and decorates it with the given context
	// and arguments.
...
// NewWithZap create a new logger using the preconfigured zap logger.
func NewWithZap(l *zap.Logger) Logger {
	return &logger{l.Sugar()}
}

// NewForTest returns a new logger and the corrosponding observed logs
