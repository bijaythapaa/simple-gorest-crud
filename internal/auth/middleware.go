...
// handleToken stores the identity in the request context so that it can be accessed elsewhere.
...
// it considered the user is autneticated as "Tester" whose ID is "100".
