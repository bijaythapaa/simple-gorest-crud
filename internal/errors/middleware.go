...
// Handler creates a middleware that handle panics
// and errors encountered during HTTP request processing
	...
	return func(c *routing.Context) (err error) {
		defer func() {
			...
			if err != nil {
				...
				c.Abort() // skip any pending handlers since an error has occured
